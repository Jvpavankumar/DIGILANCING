          ...
          <div className="px-3 max-w-screen-xl mx-auto flex justify-between items-center h-full">
            ...
            <div className="w-full max-w-[320px] items-center justify-end hidden lg:flex">
              <div className="flex items-center gap-3">
                <Link to="/Support" className={`${scrolled || isDarkMode ? 'bg-[#0183FF]' : 'bg-[#0183FF]'} py-2.5 font-outfit flex items-center justify-center px-10 text-[16px] cursor-pointer rounded-xl text-white`}>
                  <span>Support</span>
                </Link>
              </div>
            </div>
