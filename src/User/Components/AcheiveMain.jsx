...
const stats = [
  { value: '2', label: 'Achievements Unlocked', icon: b1 },
  { value: '8', label: 'Goals Remaining', icon: b2 },
  { value: '20%', label: 'Progress Completion', icon: b3 },
];
...
const AchievementPage = () => {
  return (
    <div className="bg-[#032B55] min-h-screen flex flex-col items-center">
      ...
      {/* Header */}
      <div className="w-full bg-[#043366] rounded-b-3xl py-10 flex flex-col items-center px-4 text-center">
          ...
          <div key={index} className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-left">
            ...
            <div className="w-full h-1 mt-3 rounded-full bg-gray-200">
              <div 
                ...
                style={{ width: achievement.unlocked ? "100%" : "40%" }} 
              />
            </div>
            ...
            {achievement.unlocked ? (
              <a
                ...
                className="mt-4 w-full text-center bg-blue-500 hover:bg-green-600 text-white text-sm font-medium py-2 rounded-lg transition"
              >
                View Details
              </a>
            ) : (
