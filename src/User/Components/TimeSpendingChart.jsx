...
const TimeSpendingChart = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-md w-full max-w-md mx-auto mt-5">
            <div className="flex justify-between items-start mb-2">
                ...
                <div className="bg-purple-100 text-purple-700 text-xs px-2 py-[2px] rounded-md flex items-center gap-1 font-small">
                    📅 Last 7 days
                </div>
            </div>
